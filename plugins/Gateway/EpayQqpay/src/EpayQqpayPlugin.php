...
class EpayQqpayPlugin extends AbstractPlugin implements PaymentGatewayInterface
{
    private const PAY_TYPE = 'qqpay';
    private const NAME = 'epay_qqpay';
    private const TITLE = '易支付 - QQ 钱包';
    private const DESCRIPTION = '通过彩虹易支付聚合平台收取QQ 钱包付款';
    ...
    private function notifyUrl(): string { return Route::has('plugin.epay_qqpay.notify') ? route('plugin.epay_qqpay.notify') : url('/plugin/epay_qqpay/notify'); }
