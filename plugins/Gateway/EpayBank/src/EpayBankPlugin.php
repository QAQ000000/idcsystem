...
namespace Plugins\Gateway\EpayBank\src;
...
class EpayBankPlugin extends AbstractPlugin implements PaymentGatewayInterface
{
    private const PAY_TYPE = 'bank';
    private const NAME = 'epay_bank';
    private const TITLE = '易支付 - 网银转账';
    private const DESCRIPTION = '通过彩虹易支付聚合平台收取网银付款';
    ...
    private function notifyUrl(): string { return Route::has('plugin.epay_bank.notify') ? route('plugin.epay_bank.notify') : url('/plugin/epay_bank/notify'); }
