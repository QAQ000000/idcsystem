            ...
            <tbody class="divide-y divide-slate-100">
                @forelse ($logs as $log)
                    <tr>
                        ...
                        <td class="px-4 py-3">
                            <a class="text-blue-600" href="{{ route('admin.email-logs.show', $log) }}">查看</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td class="px-4 py-6 text-center text-slate-500" colspan="8">暂无邮件日志</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
